...
function normalizeIdentityTokens(values: string[]) {
  return values
    .flatMap((value) =>
      String(value || '')
        .toLowerCase()
...
export function buildPasswordChecklist(password: string, identityValues: string[], restrictedLabel: string): PasswordChecklist {
